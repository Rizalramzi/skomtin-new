                            ...
                            <div class="bg-white pt-2 rounded-lg space-y-[4vw]  lg:space-y-[1.5vw]">
                                ...
                                <div class="grid grid-cols-1 space-y-[4vw] lg:space-y-[0.5vw]">
                                    ...
                                    <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="350" class=" ">
                                        <label for="nisn" class="block text-[4.5vw] lg:text-[1.25vw] font-medium text-gray-700 mb-[0.833vw]">NISN</label>
                                        <input type="nisn" id="nisn" name="nisn" class="w-full p-[3vw] lg:p-[1vw]  border bg-gray-100 focus:outline-none focus:ring-2 focus:ring-main rounded-[0.781vw] lg:placeholder:text-[0.938vw] placeholder:text-[3.5vw] text-[4.5vw] lg:text-[1.25vw]" placeholder="Masukkan NISN" autocomplete="off" required>
                                    </div>
                                ...
                                <div  class="text-center text-[3vw] lg:text-[1.042vw]">
                                    <p class="">Kamu Penjual? <span class="font-semibold"><a href="{{route('seller.login')}}">Masuk disini</a></span></p>
                                </div>
                            </div>
                        </form>
                    </div>
