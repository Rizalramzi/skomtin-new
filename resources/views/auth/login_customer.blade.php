                ...
                <div class="bg-white p-6 rounded-lg">
                    ...
                    <form action="{{ route('customer.login') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="nisn" name="nisn" class="w-full p-3 bg-gray-100 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-main" placeholder="Masukkan NISN" required>
                        </div>
